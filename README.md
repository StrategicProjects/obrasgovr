...
[![Codecov test
coverage](https://codecov.io/gh/StrategicProjects/obrasgov/branch/main/graph/badge.svg)](https://app.codecov.io/gh/StrategicProjects/obrasgov)
...
Contribuições são bem-vindas. Leia [CONTRIBUTING.md](CONTRIBUTING.md) e
o [Código de Conduta](CODE_OF_CONDUCT.md) antes de abrir uma issue ou
pull request.
