...
- Added HTTP/2 over TLS negotiation, transient retries, request
  throttling and actionable API errors.
- Added safe multi-page collection, typed date columns, pagination
